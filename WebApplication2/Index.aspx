                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 ps4-item">
                        <li class="list-group-item">
                            <a href="<%# Eval("Id", "Product.aspx?Id={0}") %>">
                                <img class="img-responsive ps4-images" src="images/<%#Eval("Id") %>.jpg" alt="Product Id<%#Eval("Id") %> image">
                                <div class="ps4-title">
                                    <%#Eval("Name") %>
                                </div>
                                <div class="ps4-price">
                                ...
                                <div class="ps4-quantity">
                                    Stock: <asp:Label id="lblQuantity" runat="server" Text='<%#Eval("Quantity") %>'></asp:Label>
                                </div>
                            </a>
